 ...
 */
final class Version20240220143527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE borrowing (id INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, book_id INT DEFAULT NULL, date_borrowed DATE NOT NULL, book_returned TINYINT(1) NOT NULL, INDEX IDX_226E5897CB944F1A (student_id), INDEX IDX_226E589716A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
